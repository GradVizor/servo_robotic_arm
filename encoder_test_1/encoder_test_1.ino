// #define encoder0PinA 26      // encoder 1
// #define encoder0PinB 25
// #define encoder1PinA 13     // encoder 2
// #define encoder1PinB 12

#define encoder0PinA 27      // encoder L
#define encoder0PinB 14
#define encoder1PinA 13     // encoder R
#define encoder1PinB 12
...
void loop() {
  ...
  if (currentMillis - previousMillis >= 10) {  // start timed loop for everything else
        ...
        //  Serial.print(",");
        //  Serial.print(digitalRead(encoder1PinB));
